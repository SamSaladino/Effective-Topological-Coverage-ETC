...
curl -L "https://raw.githubusercontent.com/SysBioChalmers/Human-GEM/main/model/Human-GEM.xml" \
  -o data/resources/Human-GEM2.xml
...
# Define input files
sbml_file="$resources_dir/Human-GEM2.xml"
side_compounds_file="$resources_dir/sidecomp.txt"



# Define output filenames
output_graph1="$generated_dir/compound_graph_no_sidecompounds2.gml"
output_graph2="$generated_dir/compound_graph_merged_compartments2.gml"
